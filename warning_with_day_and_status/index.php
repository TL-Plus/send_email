...
sendEmailForDays($query_dvgtgt_17_day, $header, 'Report_warning_17_days_dvgtgt.xlsx', 'Report 17-Day Warning (DVGTGT)', RECIPIENTS);

// Call function to send email notification for termination on the 19th day
sendEmailForDays($query_dvgtgt_19_day, $header, 'Report_termination_19_days_dvgtgt.xlsx', 'Report Termination on 19th Day (DVGTGT)', RECIPIENTS);

// Call function to send email notification for 17-day warning
sendEmailForDaysFixed($query_888_fixed_17_day_part1, $query_888_fixed_17_day_part2, $header, 'Report_warning_17_days_888_fixed.xlsx', 'Report 17-Day Warning (888 Fixed)', RECIPIENTS);

// Call function to send email notification for 19-day warning
sendEmailForDaysFixed($query_888_fixed_19_day_part1, $query_888_fixed_19_day_part2, $header, 'Report_warning_19_days_888_fixed.xlsx', 'Report 19-Day Warning (888 Fixed)', RECIPIENTS);
